...
from mmdet.models.utils.involution_cuda import involution
...
class FCNMaskHead_involution(nn.Module):
    ...
    def __init__(self,
        ...
        super(FCNMaskHead_involution, self).__init__()
